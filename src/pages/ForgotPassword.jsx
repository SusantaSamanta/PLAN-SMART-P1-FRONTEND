    ...
    return (
        <>
            <section className='bg-[#101114]'>
                ...
                '>
                    <motion.div className='w-full md:w-100 h-auto py-10 px-6 md:p-10 flex flex-col justify-center md:mt-4 border-t-1 md:border-2 md border-[#6d6d6d2f] rounded-3xl  bg-[#dcdcdc06] backdrop-blur-[10px]'
                    // initial={{ opacity: 0 }}
                    ...
                    >
                        ...
                        {   // 2nd page verification code enter for reset password
                            ...
                            <ResetPasswordOtpInput email={'susantasamanta@gmail.com'} length={6} />
